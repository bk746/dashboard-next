  ...
  return (
    <div className={financeFloatingCard}>
      <div className="border-b border-zinc-100 px-4 py-4 sm:px-6 sm:py-5">
        <p className="mb-3 text-[17px] font-semibold tracking-tight text-zinc-900">Factures</p>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-zinc-100">
                  ...
                  <th className="p-4 text-left text-xs font-medium text-zinc-400">Abonnement</th>
