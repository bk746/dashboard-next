...
export const objectifsPrimaryBtn =
...
export const objectifsFloatingCard =
  "overflow-hidden rounded-2xl bg-white ring-1 ring-black/[0.05] shadow-[0_1px_2px_rgba(0,0,0,0.03)]";

export const objectifsGoalCard =
  "flex h-full flex-col justify-between rounded-2xl bg-white p-5 sm:p-6 ring-1 ring-black/[0.05] shadow-[0_1px_2px_rgba(0,0,0,0.03)]";

export const objectifsInputClass =
...
export const objectifsLightLabel = "block text-[13px] font-medium text-zinc-500 mb-1.5";

export const objectifsSecondaryBtn =
...
export const objectifsVioletPrimaryBtn =
  "px-5 py-2.5 rounded-full font-semibold text-sm text-white bg-[#007AFF] transition-colors hover:bg-[#0066D6] w-full sm:w-auto";

export const objectifsProgressTrack = "w-full rounded-full bg-zinc-100 overflow-hidden";

export const objectifsProgressFill =
  "h-full rounded-full bg-emerald-500 transition-all duration-500";

export const objectifsProgressFillDone =
  "h-full rounded-full bg-emerald-500 transition-all duration-500";
